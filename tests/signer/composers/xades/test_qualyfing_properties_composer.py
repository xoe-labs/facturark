...
def data_dict():
    return {
        "@attributes": {"Target": ("#xmldsig-88fbfc45-3be2-" "4c4a-83ac-0796e1bad4c5")},
        "signed_properties": {
            "@attributes": {
...
def test_compose(composer, data_dict, schema):
    ...
    assert qualifying_properties.tag == QName(NS.xades, "QualifyingProperties").text

    assert qualifying_properties.find(QName(NS.xades, "SignedProperties")) is not None
