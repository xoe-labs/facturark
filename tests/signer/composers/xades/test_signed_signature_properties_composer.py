...
def test_compose(composer, data_dict, schema):
    ...
    assert (
        signed_signature_properties.tag
        == QName(NS.xades, "SignedSignatureProperties").text
    )
    assert (
        signed_signature_properties.findtext(QName(NS.xades, "SigningTime"))
        == "2016-07-12T11:17:38.639-05:00"
    )
