...
class BillingReferenceComposer(Composer):
    ...
    def compose(self, data_dict, root_name=None):
        ...
        invoice_document_reference_dict = data_dict.get("invoice_document_reference")
        ...
        if additional_document_reference_dict:
            ...
            make_child(
                additional_document_reference, QName(NS.cbc, "XPath"), empty=True
            )
            make_child(
                additional_document_reference, QName(NS.cac, "Attachment"), empty=True
            )
        ...
        if billing_reference_line_dict:
            ...
            make_child(billing_reference_line, QName(NS.cbc, "ID"), empty=True)
