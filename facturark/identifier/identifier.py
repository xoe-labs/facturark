...
class InvoiceIdentifier(Identifier):
    ...
    def _parse_invoice(self, invoice):
        ...
        invoice_date = (issue_date + issue_time).replace(":", "").replace("-", "")
    ...
    def _get_tax_values(self, invoice, code):
        ...
        if tax_element:
            ...
            tax_subtotal = tax_element[0].xpath(
                "ancestor::fe:TaxSubtotal", namespaces=vars(NS)
            )[0]
    ...
    def _hash_uuid(self, uuid_dict):
        uuid_list = [
            ...
            uuid_dict["invoice_date"],
            uuid_dict["invoice_value"],
            uuid_dict["tax_code_1"],
            uuid_dict["tax_value_1"],
            uuid_dict["tax_code_2"],
            uuid_dict["tax_value_2"],
            uuid_dict["tax_code_3"],
            uuid_dict["tax_value_3"],
            uuid_dict["payable_value"],
            uuid_dict["supplier_vat"],
            uuid_dict["customer_type"],
            uuid_dict["customer_vat"],
