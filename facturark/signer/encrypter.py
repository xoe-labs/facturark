...
class Encrypter:
    def __init__(self):
        self.algorithms = {
            ...
            "http://www.w3.org/2001/04/xmldsig-more#rsa-sha512": ("sha512", SHA512),
            "http://www.w3.org/2001/04/xmlenc#sha256": ("sha256", SHA256),
            "http://www.w3.org/2001/04/xmldsig-more#rsa-sha256": ("sha256", SHA256),
        }
    ...
    def verify_signature(self, certificate_b64, signature_b64, digest_b64, algorithm):
        ...
        public_key.verify(signature, digest, padding, Prehashed(hash_algorithm))

        return True

    def _parse_certificate(self, certificate_b64):
        return x509.load_pem_x509_certificate(certificate_b64, default_backend())
