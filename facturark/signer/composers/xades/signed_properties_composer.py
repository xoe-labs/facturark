...
class SignedPropertiesComposer(Composer):
    def __init__(self, signed_signature_properties_composer):
        self.signed_signature_properties_composer = signed_signature_properties_composer
    ...
    def compose(self, data_dict, root_name=None):
        ...
        signed_signature_properties_dict = data_dict["signed_signature_properties"]
        root.append(
            self.signed_signature_properties_composer.compose(
